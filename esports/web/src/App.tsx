...
function App() {
  ...
  return (
    <div className='max-w-[1344] mx-auto flex flex-col items-center my-20 px-6'>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
            ...
            <form className='mt-8 flex flex-col gap-4'>
              ...
              <div className='flex flex-col gap-2'>
                <label htmlFor="name">Seu nome no game (ou nickname)</label>
                <Input type="text" name="" id="name" placeholder='Como te chamam dentro do game?' />
              </div>

              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor="yearsPlaying">Joga há quantos anos?</label>
                  <Input type="number" name="" id="yearsPlaying" placeholder='Tudo bem ser ZERO' />
                </div>
                <div className='flex flex-col gap-2'>
                  <label htmlFor="discord">Qual seu discord?</label>
                  <Input type="text" name="" id="discord" placeholder='Usuário#0000' />
                </div>
              </div>
              ...
              <div className='flex gap-6'>
                <div className='flex flex-col gap-2'>
                  ...
                  <div className='grid grid-cols-4 gap-2'>
                    ...
                    <button className='w-8 h-8 rounded bg-zinc-900' title='Segunda'>D</button>
